...
echo "<a href='http://akuzo.click:6080/nico/account' target=_blank>account</a><br>";
...
while($row = mysql_fetch_assoc($result))
{
	...
	{
		echo "<td>\n";
		echo "<a href=\"table.php?database=$value\" target=\"_blank\">".$value."</a>\n";
		echo "</td>\n";
	}
/*
